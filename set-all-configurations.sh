...
sed -i -e "/^tks.spine.sds.reference/c\tks.spine.sds.reference /home/service/external_configuration/siab-test-sds-ref_AutoTester.xml" ${configDirectory}/tkw-x_mth_server_ssl.properties
...
sed -i -e 's|TKW_ROOT/config/SPINE_MTH_EPS_Dispenser_Simulator/external_configuration/EPSMessageTemplates/|/home/service/external_configuration/EPSMessageTemplates/|g' ${configDirectory}/simulator_config/EPS_Dispenser_AutoTest_Ruleset.txt
